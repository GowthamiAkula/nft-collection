...
export namespace MintPausedEvent {
...
export interface NftCollection extends BaseContract {
  ...
  isApprovedForAll: TypedContractMethod<
    [owner_: AddressLike, operator: AddressLike],
    [boolean],
    "view"
  >;
  ...
  getEvent(
    ...
    MintPausedEvent.InputTuple,
    MintPausedEvent.OutputTuple,
    MintPausedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "MintPaused(bool)": TypedContractEvent<
      MintPausedEvent.InputTuple,
      MintPausedEvent.OutputTuple,
      MintPausedEvent.OutputObject
    >;
    MintPaused: TypedContractEvent<
      MintPausedEvent.InputTuple,
      MintPausedEvent.OutputTuple,
      MintPausedEvent.OutputObject
    >;
